...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'YiypZJea_qPsOLJ',
      'isDeleted':false,
      'username':'Olaf30',
      'email':'Chesley55@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Olaf30' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'WuhUSSdqFB16JJi',
      'isDeleted':false,
      'username':'Ashtyn29',
      'email':'Westley68@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Ashtyn29' }, userToBeInserted,  { upsert: true });
