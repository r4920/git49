...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ramona20',
      password: 'fLj9yTh9UX3RzJF',
      email: 'Lavern15@hotmail.com',
      name: 'Josh Cormier',
      userType: 727,
      mobileNo: '(921) 098-6883',
      resetPasswordLink: {},
      loginRetryLimit: 717,
      loginReactiveTime: '2023-01-25T21:22:05.319Z',
      id: '6267f409f5bd1ce1c09f5163'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Mustafa89',
        'password':'RJzoAMM0kpXHY65',
        'email':'Doug63@yahoo.com',
        'name':'Michele Jacobi',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(970) 293-8331',
